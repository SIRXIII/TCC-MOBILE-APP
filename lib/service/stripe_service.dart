...
class StripeService {
  ...
  static Future<StripeTransactionResponse> payWithPaymentSheet({
    ...
    try {
      ...
      var response = await http.post(
        Uri.parse('${StripeService.paymentApiUrl}/${paymentIntent['id']}'),
        headers: headers,
      );
  ...
  static Future<Map<String, dynamic>?> createPaymentIntent({
    ...
    // String orderId = 'wallet-refill-user-${context!.read<UserProvider>().userId}-${DateTime.now().millisecondsSinceEpoch}-${Random().nextInt(900) + 100}';
